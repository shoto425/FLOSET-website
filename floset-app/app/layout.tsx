...
export default function RootLayout({
  ...
  return (
    ...
    >
      <head>
        {/* Google Analytics 4 */}
        <Script src="https://www.googletagmanager.com/gtag/js?id=G-F3M7GZC1BR" strategy="afterInteractive" />
        <Script id="google-analytics" strategy="afterInteractive">
          {`window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());
gtag('config', 'G-F3M7GZC1BR');`}
        </Script>
        {/* Microsoft Clarity */}
...
})(window, document, "clarity", "script", "xed9t19j96");`}
        </Script>
